...
const BACKEND_URL = 'https://c955-2800-484-8786-7d00-5963-3db4-73c3-1a5c.ngrok-free.app';
    ...
    try {
        ...
        const response = await fetch(API_ENDPOINTS.publicidad, {
            ...
            body: JSON.stringify({
                ...
                cc_destinatario: 'daniel.rr93g@gmail.com' || emailDestino, // Con copia al usuario si proporcionó email
